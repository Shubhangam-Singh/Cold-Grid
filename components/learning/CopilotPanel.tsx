...
export default function CopilotPanel() {
  ...
  if (!open) {
    return (
      <button
        ...
        className="absolute right-3 top-3 lg:right-4 lg:top-auto lg:bottom-4 z-30 flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-950/85 px-3 py-2 text-xs font-medium text-slate-200 backdrop-blur transition hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-400"
        aria-expanded={false}
      >
  ...
  return (
    <div className="absolute right-3 top-3 lg:right-4 lg:top-auto lg:bottom-4 z-30 max-h-[70vh] lg:max-h-[60vh] w-[min(18rem,calc(100vw-1.5rem))] lg:w-72 overflow-y-auto rounded-lg border border-slate-800 bg-slate-950/90 p-3 backdrop-blur">
